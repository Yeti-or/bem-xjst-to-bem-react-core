...
describe('Modes elem(elemName)', function() {
  xit('should support elem() match', function () {
    test(function() {
  ...
  xit('should apply elem(*) template', function() {
    test(function() {
      block('b').elem('*').tag()('b');
    },
    [
  ...
  xit('elem(*) should be called before the matched templates',
    function() {
    test(function() {
  ...
  xit('should apply several elem(*) templates in proper order', function() {
    test(function() {
